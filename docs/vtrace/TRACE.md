...
VTRACE adoption scope: connect SHIELD's accepted requirements to mission needs, CONOPS scenarios,
controlled specification items, future design surfaces, work packages, verification, validation,
and evidence. SHIELD is greenfield: design elements, work packages, and evidence are
...
| REQ-004 | NEED-004 / CON-002 / OPS-001 | SPEC-001 | healthcare delivery kernel (`shield-network`) | deferred → IMPL_PLAN | VER-004 / schema check | OPS-001 | future EVID-004 | accepted |
...
| DEF-002 | Staffed-bed/provider/slot capacity, surge-vs-baseline basis, and non-fungible service-line capacity. | `SPECIFICATION_BASELINE` (SPEC-SG-02 / SPEC-BL-02 / SPEC-UNK-004) | deferred |
...
| SPEC-UNK-002 | Referral/catchment edge semantics for DIM-04 and diverse-path resilience. | health-system planner | accepted transfer risk |
| SPEC-UNK-003 | Single 0-10 score fairness across physical and social dimensions. | equity/public-health reviewers | defer to calibration |
| SPEC-UNK-004 | Non-fungible bed/provider/service-line capacity. | operations reviewer | accept risk (labelled basis) |
| SPEC-UNK-005 | Scale nesting representation. | SHIELD maintainer | defer (DEF-005) |
...
- No `VER-*` evidence exists yet; verification methods are named but unrun. The next stage
  ...
  packages run.
- Dimension weights, SLA thresholds, scale nesting, referral-connectivity semantics, single-score fairness, and capacity fungibility are provisional; the trace does not claim calibrated values.
...
| Health-System Planner | NEED-007/008 trace cleanly to REQ-014/015/016 and SPEC-011/012/013; transfer-strain unknowns remain visible. | pass_with_risk |
